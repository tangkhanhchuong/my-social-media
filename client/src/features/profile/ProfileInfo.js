...
const ProfileInfo = () => {
  ...
  return (
    <Wrapper>
      ...
      <SInfoContainer>
        <StAvatar top={70} lg src={generateFilePath(initAvatar)} alt="profile" />
                ...
                {formikProps => {
                    return ( 
                      <Form>
                        ...
                        <OverlayImagePicker avatar circle onChange={(e)=>setAvatar(e.target.files[0])}>
                          <StAvatar top={50} left={10} md src={generateFilePath(avatar)} alt="profile" />
                        </OverlayImagePicker>  
