...
const messageSlice = createSlice({
  ...
  reducers: {
    ...
    addConversation: (state, action) => {
      ...
      state.allConversations = sortObjectKeysByTimestamp(
        state.allConversations
      );
      state.allConversations[chatId].messages = state.allConversations[
        chatId
    ...
    loadMoreMessages: (state, action) => {
      ...
      const messages = [
        ...moreMessages,
        ...state.allConversations[chatId].messages,
    ...
    changeStickersSuit: (state, action) => {
      ...
      const desStickerSuit = state.stickers.collection.filter(
        (c) => c._id === desStickerSuitId
      )[0];
